...
public class SettingsController implements Controller<Node> {
  ...
  public void initialize() {
    ...
    backgroundImageLocation.textProperty().bindBidirectional(preferences.getMainWindow().backgroundImagePathProperty());
  ...
  public void onSelectBackgroundImage() {
    Platform.runLater(() -> {
      ...
      preferencesService.getPreferences().getMainWindow().setBackgroundImagePath(result.getPath());
      preferencesService.storeInBackground();
    });
  }
